...
{ "auto", "en", "en_GB", "ca", "da", "de", "es", "fr", "he", "hi" "hu", "it", "ja",
...
N_("Hebrew"), N_("Hindi"), N_("Hungarian"), N_("Italian"), N_("Japanese"),
N_("Georgian"), N_("Korean"), N_("Dutch"), N_("Occitan"), N_("Brazilian Portuguese"),
N_("Romanian"), N_("Russian"), N_("Turkish"), N_("Simplified Chinese"),
